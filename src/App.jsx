...
import aimodal from '/src/assets/aimodal.png'
...
function App() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-b from-zinc-800 to-black
 flex flex-col items-center justify-start'>

      <div className='h-[70vh] w-[50vh] overflow-hidden flex items-center justify-center flex-col'>
        <img src={aimodal} alt="aimodal" className='h-[70%] object-contain bg-transparent' />
      ...
      {!speaking ? (
        <div className='flex flex-row items-center gap-3'>
          <button className='font-bold text-2xl bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600  w-40 h-10 rounded-full flex flex-row items-center justify-center gap-1  shadow-[0_0_15px_1px_rgba(34,211,238,0.6)]' onClick={() => {
            recognition.start()
            setspeaking(true)
        ...
        <div className='flex flex-col items-center justify-center'>
          {!response ? <img src={speakimg} alt="mic" className='w-[100px] object-contain bg-transparent' />
            :
          ...
          <div className='mt-4'>
            <button className='font-semibold text-sm bg-gradient-to-r from-red-600 via-red-700 to-red-900 shadow-[0_0_20px_2px_rgba(185,28,28,0.7)] text-white px-4 py-2 rounded-full hover:opacity-90' onClick={() => stopSpeaking()}>
              Stop Speaking
            </button>
          </div>
        </div>
